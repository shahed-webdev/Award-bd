<%@ Page Title="" Language="C#" MasterPageFile="~/Inside.Master" AutoEventWireup="true" CodeBehind="Iftar_B_List.aspx.cs" Inherits="Award__bd.Beneficiary.Iftar.Iftar_B_List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/JS/jq_Profile/css/Profile_jquery-ui-1.8.23.custom.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h3>Iftar Beneficiary List</h3>
...
INSERT INTO Beneficiary_IfterAssign(RegistrationID, BenefitCategoryID, BeneficiaryID) VALUES (@RegistrationID, @BenefitCategoryID, @BeneficiaryID)">
        ...
        <div id="AssignRecord">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="AssignRecordGridView" runat="server" AutoGenerateColumns="False" CssClass="mGrid" DataSourceID="AssignRecordSQL" AllowSorting="True" AllowPaging="True" DataKeyNames="Ifter_AssignID">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="AssignRecordSQL" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT Beneficiary_Info.BeneficiaryID, Beneficiary_Info.RegistrationID, Beneficiary_Info.BeneficiaryName, Beneficiary_Info.Beneficiary_DOB, Beneficiary_Info.Beneficiary_NID, Beneficiary_Info.FatherName, Beneficiary_Info.Father_DOB, Beneficiary_Info.Father_NID, Beneficiary_Info.MotherName, Beneficiary_Info.Mother_DOB, Beneficiary_Info.Mother_NID, Beneficiary_Info.GuardianName, Beneficiary_Info.Guardian_DOB, Beneficiary_Info.Guardian_NID, Beneficiary_Info.PresentAddress, Beneficiary_Info.ContactNo, Beneficiary_Info.PermanentAddress, Beneficiary_Info.EntryDate, Beneficiary_Info.Categoty, Beneficiary_Info.Reference, CAST(Beneficiary_Info.CaseNo AS nvarchar(50)) AS CaseNo, Beneficiary_Info.WorkingPerson_in_Family, Beneficiary_Info.Monthly_Income_in_Family, Beneficiary_Info.Total_Stu_in_Family, Beneficiary_Info.FastingMember, Beneficiary_Info.Other_Benefit, Beneficiary_Info.Is_Approved, Beneficiary_Info.ApprovedBy_ID, Beneficiary_Info.VolunteerID, Beneficiary_Info.Observation, Beneficiary_Info.InsertDate, Beneficiary_Info.CaseNo AS Case_No_Sort, Beneficiary_IfterAssign.Ifter_AssignID FROM Beneficiary_Info INNER JOIN Beneficiary_IfterAssign ON Beneficiary_Info.BeneficiaryID = Beneficiary_IfterAssign.BeneficiaryID WHERE (Beneficiary_Info.Is_Approved = 1) AND (Beneficiary_Info.Is_Service_On = 1) AND (Beneficiary_IfterAssign.IsUsed = 0) ORDER BY CaseNo"
                        FilterExpression="BeneficiaryName LIKE '{0}%' or ContactNo LIKE '{0}%' or CaseNo LIKE '{0}%'" CancelSelectOnNullParameter="False" DeleteCommand="DELETE FROM Beneficiary_IfterAssign WHERE (Ifter_AssignID = @Ifter_AssignID)">
                        <DeleteParameters>
                            <asp:Parameter Name="Ifter_AssignID" />
                        </DeleteParameters>
                        <FilterParameters>
                            <asp:ControlParameter ControlID="FindTextBox" Name="find" PropertyName="Text" />
                        </FilterParameters>
