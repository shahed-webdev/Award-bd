<%@ Page Title="" Language="C#" MasterPageFile="~/Inside.Master" AutoEventWireup="true" CodeBehind="Iftar_Card.aspx.cs" Inherits="Award__bd.Beneficiary.Iftar.Iftar_Card" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Card/CSS/Iftar.css" rel="stylesheet" />
</asp:Content>
        ...
        <asp:Repeater ID="IftarCardRepeater" runat="server" DataSourceID="IftarCardSQL">
            <ItemTemplate>
                <div>
                    <div class="C-header">
                        <div>
                            <img src="../Card/CSS/award_logo.JPG" />
                        </div>
                        <div>
                            <h5>IFTAR CARD-<span class="C-Year"></span>- <b style="color: #FF6600"><%# Eval("CaseNo") %></b></h5>
                        </div>
                        <div>
