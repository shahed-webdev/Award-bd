<%@ Page Title="" Language="C#" MasterPageFile="~/Inside.Master" AutoEventWireup="true" CodeBehind="CV.aspx.cs" Inherits="Award__bd.Volunteer.CV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   ...
   <a onclick="window.print();" class="NoPrint">Print</a>
   <script>
      $(function () {
