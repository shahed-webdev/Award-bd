<%@ Page Title="" Language="C#" MasterPageFile="~/Out_Side.Master" AutoEventWireup="true" CodeBehind="Create_Delete_Role.aspx.cs" Inherits="Award__bd.Page_Link.Create_Delete_Role" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="Role">
     <h3>Manage Roles</h3>
       <a href="Category.aspx">Link Category</a>
        <table>
            <tr>
